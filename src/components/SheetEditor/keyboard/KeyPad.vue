<template>
  <div
    class="bg-gray-800 text-gray-500 text-sm rounded-lg  overflow-hidden p-5  bottom-0 m-auto block"
    style="width:100vw"
  >
      ...
      <div>
        <div class="flex -mx-1 justify-center">
          <div class="key-wrapper">
            <button class="key" v-on:click="onInput('note', 'A')">
              A
            </button>
          </div>
          <div class="key-wrapper">
            <button class="key" v-on:click="onInput('note', 'B')">
              B
            </button>
          </div>
          <div class="key-wrapper">
            <button class="key" v-on:click="onInput('note', 'C')">
              C
            </button>
          </div>
          <div class="key-wrapper">
            <button class="key" v-on:click="onInput('note', 'D')">
              D
            </button>
          </div>
          <div class="key-wrapper">
            <button class="key" v-on:click="onInput('note', 'E')">
              E
            </button>
          </div>
          <div class="key-wrapper">
            <button class="key" v-on:click="onInput('note', 'F')">
              F
            </button>
          </div>
          <div class="key-wrapper">
            <button class="key" v-on:click="onInput('note', 'G')">
              G
            </button>
          </div>
        </div>
        <div class="flex -mx-1">
          ...
          <div class="key-wrapper" style="width:6em">
            <button
              class="block w-full h-10 rounded bg-gray-900 hover:bg-indigo-600 hover:text-white shadow focus:outline-none text-center leading-none"
