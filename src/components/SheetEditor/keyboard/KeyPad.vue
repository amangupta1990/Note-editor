      ...
      <div>
        <div class="flex -mx-1 justify-center">
          <div class="w-10 px-1 mb-2">
            <button
              class="block w-full h-10 rounded bg-gray-700 hover:bg-indigo-600 hover:text-white shadow focus:outline-none text-center leading-none"
