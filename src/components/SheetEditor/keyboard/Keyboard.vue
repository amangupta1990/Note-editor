<template>
  ...
  <div class="tabs">
      <ul>
          <li v-bind:class="{ active: tab ==='KEYPAD' }"  v-on:click="tab='KEYPAD'"   >
              ABC..
          </li>
          <li v-bind:class="{ active: tab ==='DRAWER' }"  v-on:click="tab='DRAWER'"  >
              Chords
          </li>
          <li v-bind:class="{ active: tab ==='RYTHYM' }"  v-on:click="tab='RYTHYM'"  >
              Ryth
          </li>
      </ul>
  </div>
